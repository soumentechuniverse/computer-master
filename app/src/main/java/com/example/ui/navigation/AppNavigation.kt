...
fun AppNavigation(
    ...
    // Login/Sign-in is disabled.
    // The app always starts from the Splash screen.
    val startDest = NavRoutes.SPLASH
    ...
    NavHost(
            ...
            HomeScreen(
                ...
                onNavigateToCourse = { courseId ->
                    navController.navigate(
                        NavRoutes.courseDetail(courseId)
                    )
                },
                ...
                onNavigateToHardwareVisualLesson = {
                    navController.navigate(
                        NavRoutes.HARDWARE_VISUAL_LESSON
                    )
                },
                onNavigateToCpuRamRomLesson = {
                    navController.navigate(
                        NavRoutes.CPU_RAM_ROM_LESSON
                    )
                },
        ...
        composable(
            ...
            ComputerHardwareVisualLessonScreen(
                ...
                onNavigateToLesson = { cId, lId ->
                    navController.navigate(
                        NavRoutes.lessonDetail(cId, lId)
                    )
                }
            )
        }
        ...
        composable(NavRoutes.SETTINGS) {
            SettingsScreen(
                ...
                onLogout = {
                    // Login is disabled.
                    // Return to Splash instead of Auth screen.
